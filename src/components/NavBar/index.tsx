      ...
      <Navbar>
        ...
        <NavBody>
          ...
          <div className="flex items-center gap-4">
            <NavbarButton className="bg-primary-light dark:bg-primary text-bg-1-light dark:text-bg-1 hover:bg-primary-light/90 dark:hover:bg-primary/90 font-semibold" >Book a call</NavbarButton>
           <ThemeToggle />
          </div>
        </NavBody>
